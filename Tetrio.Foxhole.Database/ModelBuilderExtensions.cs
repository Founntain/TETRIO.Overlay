...
public static class ModelBuilderExtensions
{
    ...
    private static void GenerateConditionRanges(ModelBuilder modelBuilder)
    {
        ...
        ranges.Add(new () {Id = new Guid("11111111-1111-1111-1111-111111111010"), CreatedAt = date, UpdatedAt = date, Difficulty = Difficulty.Community, ConditionType = ConditionType.BackToBack, Min = 250000,  Max = 1000000});
        ...
        ranges.Add(new () {Id = new Guid("11111111-1111-1111-1111-111111111110"), CreatedAt = date, UpdatedAt = date, Difficulty = Difficulty.Easy, ConditionType = ConditionType.BackToBack, Min = 3,    Max = 7});
        ...
        ranges.Add(new () {Id = new Guid("11111111-1111-1111-1111-111111111210"), CreatedAt = date, UpdatedAt = date, Difficulty = Difficulty.Normal, ConditionType = ConditionType.BackToBack, Min = 7,   Max = 25});
        ...
        ranges.Add(new () {Id = new Guid("11111111-1111-1111-1111-111111111310"), CreatedAt = date, UpdatedAt = date, Difficulty = Difficulty.Hard, ConditionType = ConditionType.BackToBack, Min = 25,   Max = 50});
        ...
        ranges.Add(new () {Id = new Guid("11111111-1111-1111-1111-111111111410"), CreatedAt = date, UpdatedAt = date, Difficulty = Difficulty.Expert, ConditionType = ConditionType.BackToBack, Min = 20,   Max = 80});
